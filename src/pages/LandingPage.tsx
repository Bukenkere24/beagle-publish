  ...
  return (
    <div className="min-h-screen bg-beagle-bg text-beagle-text-body overflow-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-beagle-border bg-beagle-bg/80 backdrop-blur-md">
        <div className="max-w-beagle mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        <div className="max-w-beagle mx-auto text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-heading font-extrabold text-beagle-text-heading leading-[0.95] tracking-tighter mb-8 max-w-4xl mx-auto">
      ...
      {/* Feature Grid */}
      <section className="py-20 px-6 border-t border-beagle-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div
                ...
                className="bg-gradient-to-b from-white/[0.04] to-white/[0.01] border border-beagle-border rounded-beagle p-8 group hover:border-beagle-primary/50 transition-all"
              >
                ...
                <p className="text-beagle-text-muted leading-relaxed">
                  {feature.desc}
                </p>
              </motion.div>
            ))}
